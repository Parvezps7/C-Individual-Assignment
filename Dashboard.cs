...
namespace UniversityBookStoreManagement.cs
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=LAPTOP-69GVVKF1;Initial Catalog=library;Integrated Security=True");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into Dashboard values (@Product_ID,@Product_Name,@Customer_Name,@Customer_No,@Date)", con);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Update Dashboard set Product_ID=@Product_ID, Product_Name=@Product_Name, Customer_Name=@Customer_Name ,Customer_No=@Customer_No,Date =@Date", con);
            cmd.Parameters.AddWithValue("@Product_ID", int.Parse(textBox1.Text));
            cmd.Parameters.AddWithValue("@Product_Name", (textBox2.Text));
            cmd.Parameters.AddWithValue("@Customer_Name", (textBox3.Text));
            cmd.Parameters.AddWithValue("@Customer_No", (textBox4.Text));
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Delete Dashboard where Product_ID=@Product_ID ", con);
            cmd.Parameters.AddWithValue("@Product_ID", int.Parse(textBox1.Text));
            cmd.ExecuteNonQuery();
            con.Close();
